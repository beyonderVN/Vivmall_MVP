 ...
 * retrieving data related to an specific {@link com.brothers.admin.kill_some_time.domain.Item}.
 */
public class GetProductDetails extends UseCase {

  private final int userId;
  private final Repositoty productRepositoty;

  @Inject
  public GetProductDetails(int userId, Repositoty userRepository,
