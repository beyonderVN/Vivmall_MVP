package com.example.vinhsang.vivmall.model;
...
public class ItemProduct implements Serializable {
    ...
    public ItemProduct(String strobj) {
        ItemProduct itemProduct=new Gson().fromJson( strobj, ItemProduct.class);
        this.product_id = itemProduct.product_id;
        this.product_price = itemProduct.product_price;
        this.product_name = itemProduct.product_name;
        this.product_image = itemProduct.product_image;
    }
}
