...
package com.example.vinhsang.vivmall.presentation.coremvp;
 ...
 */
public abstract class MVPViewDelegate<M extends Serializable, V extends MVPView, P extends MVPPresenter<V, M>> {
     ...
     * Presentation Model
     */
    public void onCreate(MVPView mvpView, @Nullable Bundle savedInstanceState) {
    ...
    private void checkPresenter() {
        if (presenter == null) {
            throw new IllegalStateException(
                "call onCreate in MVPViewDelegate, because presenter is missing");
        }
    }
