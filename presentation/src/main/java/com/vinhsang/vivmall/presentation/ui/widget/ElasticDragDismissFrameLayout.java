...
package com.vinhsang.vivmall.presentation.ui.widget;
...
import com.vinhsang.vivmall.presentation.util.AnimUtils;
import com.vinhsang.vivmall.presentation.util.ColorUtils;
import com.vinhsang.vivmall.presentation.util.ViewUtils;
...
public class ElasticDragDismissFrameLayout extends FrameLayout {
    ...
    public static abstract class ElasticDragDismissCallback {
         ...
         * @param rawOffsetPixels     The raw distance the userModel has dragged
         */
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed) {
        // if we're in a drag gesture and the userModel reverses up the we should take those events
