...
package com.vinhsang.vivmall.presentation.ui.widget.viewpager.viewpager;
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        if (isAttachedToWindow) {
            ...
            if (currentPosition != position) {
                ...
                // if userModel scrolls completely to next page then the position param updates to that
